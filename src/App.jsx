			...
			<main id='main'>
				<section className='hero' id='home' aria-labelledby='hero-title'>
					<img
						...
						alt='Рабочее место frontend-разработчика с ноутбуком, макетами сайтов и дизайн-системой'
					/>
					...
					<div className='hero__content container'>
						...
						<p className='hero__lead'>
							Создаю адаптивные сайты на React: чистая верстка, понятные
				...
				>
					<div className='container intro'>
						<div>
							...
							<h2 id='intro-title'>
								Разрабатываю сайты, в которых порядок виден сразу
							</h2>
						</div>
					...
					<div className='container stack-layout'>
						<div className='stack-copy'>
							...
							<p>
								...
								собирать сайты из понятных компонентов, поддерживать типизацию и
								быстро менять визуальные блоки.
							</p>
						</div>
				...
				>
					<div className='container contact'>
						<div>
							...
							<h2 id='contact-title'>
								Готов развивать ваши идеи и реальные проекты
							</h2>
							<p>
								Если вам нужен современный сайт, удобный интерфейс или помощь в
								реализации веб-проекта — я открыт к сотрудничеству. Расскажите о
								своей идее, и вместе мы найдём лучшее решение для её развития.
							</p>
						</div>
